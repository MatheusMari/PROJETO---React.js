...
import { fetchRecipesByCategory } from "../redux/recipeSlice.js"; // Ação para buscar receitas por categoria
...
const RecipeList = () => {
    ...
    if (error) return <p>Erro ao carregar receitas: {error.message || error}</p>; // Exibindo erro de forma mais clara
